...
namespace Swordfish.Navigation
{
    ...
    public class PathfindingGoal
    {
        ...
        public static bool CheckGoal(Actor actor, Body target, PathfindingGoal[] goals) => CheckGoal(actor, target.GetCell(), goals);
        ...
        public static bool CheckGoal(Actor actor, Body target, PathfindingGoal goal) => CheckGoal(actor, target.GetCell(), goal);
        ...
        //  Try a set of goals
        public static bool TryGoal(Actor actor, Body target, PathfindingGoal[] goals) => TryGoal(actor, target.GetCell(), goals);
        ...
        //  Try a single goal
        public static bool TryGoal(Actor actor, Body target, PathfindingGoal goal) => TryGoal(actor, target.GetCell(), goal);
